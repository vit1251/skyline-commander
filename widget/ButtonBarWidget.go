...
//    pub fn set_label(&mut self, key: u8, label: &str) {
//        let idx: usize = (key - 1) as usize;
//        self.labels[idx].text = String::from(label);
//    }

//    fn init_button_positions(&mut self, area: &Rect) {
...
//    pub fn get_button_width(&self, idx: usize) -> usize {
//        if idx == 0 {
